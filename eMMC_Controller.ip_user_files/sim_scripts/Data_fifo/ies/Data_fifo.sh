...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../eMMC_Controller.srcs/sources_1/ip/Data_fifo/sim/Data_fifo.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.Data_fifo $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.Data_fifo -input simulate.do
}
# Script usage
usage()
{
