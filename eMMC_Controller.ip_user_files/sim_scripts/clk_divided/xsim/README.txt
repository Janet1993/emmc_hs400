...
#
# Generated by export_simulation on Wed Oct 19 19:02:58 +0800 2016
#
################################################################################
...
switch to the './clk_divided.sh' script.

./clk_divided.sh -reset_run
...
./clk_divided.sh -noclean_files

For more information on the script, please type './clk_divided.sh -help'.
