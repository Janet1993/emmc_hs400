...
#
# Generated by export_simulation on Wed Aug 17 20:14:52 +0800 2016
#
################################################################################
...
switch to the './Command_fifo.sh' script.

./Command_fifo.sh -reset_run
...
./Command_fifo.sh -noclean_files

For more information on the script, please type './Command_fifo.sh -help'.
